...
const FormCompound = (props) => {
  ...
  return (
    <div className="w-[45rem] flex items-center justify-center border z-20 py-5 rounded-3xl relative light-secondary dark: dark-secondary border-[#3730A3] dark: border-whitea">
      <form
        onSubmit={submitHandler}
        className="w-96 flex flex-col items-center justify-center z-20 gap-y-4"
      >
